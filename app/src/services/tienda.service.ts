...
export class TiendasService {
    ...
    private obtenerTienda= 'https://appayservidor.herokuapp.com/tiendas';

    //Metodo que busca la tienda
     buscarTienda(id: any){
        this.obtenerTienda= 'https://appayservidor.herokuapp.com/tiendas?id='+id;
        return this.http.get(this.obtenerTienda).map(this.extractData);
     }
